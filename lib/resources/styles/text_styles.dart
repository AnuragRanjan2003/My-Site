...
class ProjectTextStyles {
  static const body = TextStyle(color: ProjectColors.textColor , fontSize: 17 , overflow: TextOverflow.ellipsis,);
  ...
  static const date = TextStyle(color: ProjectColors.grey , fontSize: 17, fontWeight: FontWeight.w300);
  static const highlightedItem = TextStyle(color: ProjectColors.textColor , fontSize: 28 , fontWeight: FontWeight.w700);
  static const highlightedButtonText = TextStyle(color: ProjectColors.textColor , fontSize: 18 , fontWeight: FontWeight.w700);
  static const onItemStyle = TextStyle(color: ProjectColors.textColor , fontSize: 16 , overflow: TextOverflow.ellipsis);
  ...
  static const highLightedTitle = TextStyle(color: Colors.white , fontSize: 70 , fontWeight: FontWeight.w700);
  ...
  static const smallHighLightedText =TextStyle(color: ProjectColors.textColor , fontSize: 14, fontWeight: FontWeight.w500);
